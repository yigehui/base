<%@ page language="java" import="java.util.*,com.ygh.shop.model.*" pageEncoding="UTF-8"%>
	...
	$(function() {
			...
			$(".text").change(function() {
				...
				if(!isNaN(value) && parseInt(value)==value && value>0) 
				{
					...
					//发送ajax请求,更新购物项
					$.post("Sorder_update.action",{number:value,'product.id':pid},function(total){
						$("#total").html(total);
						$("#price").html(total);
					},"text");
					//更新商品小计
					$(this).parent().next().html(($(this).parent().prev().html()*value).toFixed(2));
		...
		<div class="header">
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<!-- 小购物车 -->
				  <div class="minicart">
                        <a class="minicart_link" href="<%=path %>/showForder.jsp">
                            <span class="item"> <b>${sessionScope.forder_number}</b> 件/
                            </span>
		...
		<div class="section_container">
			...
			<div id="shopping_cart">
				...
				<table class="data-table cart-table" cellpadding="0" cellspacing="0">
					...
					<tr id="sorder" lang="${sorder.product.id}">
						<td class="align_center"><a href="#" class="edit">${sorder.product.id}</a>
						</td>
						<td width="80px"><img src="image/${sorder.product.pic }" width="80"
							height="80" />
						</td>
				...
				<div class="totals">
						...
						<tbody>
							<tr>
								...
								<td class="align_right" style=""><strong><span
										class="price" id="price">￥${sessionScope.forder.total}</span>
								</strong>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="total" style=""><span class="total" id="total">￥${sessionScope.forder.total}</span>
								</td>
							</tr>
						</tbody>
					</table>
					<div class="action_buttonbar">
						<button type="button" title="" class="checkout fr"
							...
							<font><a href="user/confirm.jsp" >结帐</a></font>
							
						</button>
						<button type="button" title="清空购物车" class=" fr">
							<font><font>清空购物车</font>
							</font>
						</button>
						<button type="button" title="继续购物" class="continue fr">
							<font><font>继续购物</font>
							</font>
						</button>
