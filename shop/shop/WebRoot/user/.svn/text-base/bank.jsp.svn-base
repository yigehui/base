        ...
        <div class="section_container">
            ...
            <div class="pay-step">
                ...
                <div class="pay">
                    <div class="pay-inner">
                        ...
                        <div class="fl yibao-logo">
                             <a href=""><img src="<%=path %>/image/bank/yibao/yibao.jpg" width="110" height="35" alt="" /></a>
                        </div>
                ...
                <div class="select-bank">
                	 <form action="<%=path %>/Pay_goBank.action" method="post">
                    <h1>请选择支付银行</h1>
                    <!-- 获得银行参数名称 {fn:indexOf(name,'.'))}  {fn:substring(zip, 6, -1)} -->
                    <div>
                        <ul>
