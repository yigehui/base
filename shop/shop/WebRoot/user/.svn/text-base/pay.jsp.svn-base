		...
		<div class="section_container">
			<div class="pay-skip">
				...
				<div class="payskip-inner">
					...
					<div>
						<span>支付方式：</span><img class="zffs" src="images/yibao.png" alt="" />
					</div>
					<div>
						<span>支付银行：</span><img class="zfyh" src="<%=path %>/image/bank/${requestScope.pd_FrpId}.gif"
							alt="" />
					</div>
					...
					<div>
						<form name="yeepay" action='https://www.yeepay.com/app-merchant-proxy/node' method='POST' target="_blank">
							...
							<div class="pay-sub"><input value="登陆网上银行，立即支付" type='submit' /></div>
						</form>
