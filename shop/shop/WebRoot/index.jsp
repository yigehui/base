  ...
  <body>
	<div class="wrapper">
                ...
                <!--头部开始-->
                        <div class="top_bar clear">
                            ...
                            <ul class="top_links fr">
                                ...
                                <li><a href="#">我的账户</a></li>
                                <li><a href="showForder.jsp">购物车</a></li>
                                <li><a href="#">注册</a></li>
        ...
        <div class="section_container">
            ...
            <!-- 产品列表 -->
             <!-- 大循环开始 -->
            <c:forEach items="${applicationScope.productlist}" var="list">
            <div class="products_list products_slider clear">
                ...
                <!-- 小循环开始 -->
                    ...
                    <li> 
                    <a  href="<%=path %>/Product_get.action?id=${product.id}"class="product_image"><img src="image/${product.pic}" /></a>
                        <div class="product_info">
                            <h3><a href="#">${product.name}</a></h3>
                            <small>${product.remark}</small> </div>
                        <div class="price_info"> 
                            </button><button><span class="pr_add">添加购物车</span></button><button class="price_add" title="" type="button"><span class="pr_price">￥${product.price}</span>
                        </div>
                    </li>
                     </c:forEach>              
                </ul>
