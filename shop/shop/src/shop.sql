...
/* 修改自动增长的初始值 */
ALTER TABLE forder AUTO_INCREMENT = 20160531;
...
INSERT INTO product (name,price,pic,remark,xremark,commend,open,cid) VALUES 
('老电椅',199.00,'test.jpg','这里是简单介绍','这里是详细介绍',true,true,4);
...
VALUES ('user','弋戈辉','user','男','15515979336','yigehui2.163.com');
...
SELECT * FROM product where name like '电%';
SELECT * FROM user;
SELECT * FROM status;
SELECT * FROM forder;
SELECT * FROM sorder;
select sum(number), name from sorder group by pid;
